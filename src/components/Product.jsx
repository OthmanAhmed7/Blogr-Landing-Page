        ...
        <div className="flex flex-col gap-10 m-auto text-center md:text-left">
          <div>
            ...
            <p className="text-slate-600 w-[25rem]">
              Lorem ipsum dolor sit amet conremsectetur adipisicing elit. Natus
              nesciunt saepe, deserunt delectus voluptatibus itaque dignissimos
              voluptatem harum quae consequatur assumenda iure vitae ipsum
              minima provident incidunt. Fugiat, delectus enim!
            </p>
          </div>
