    ...
    <div>
      ...
      <div className="w-[100%] phone-bg padding rounded-tr-[6rem] rounded-bl-[6rem] relative overflow-hidden text-center">
        ...
        <p className="relative z-40 pb-16 text-slate-200">
          ...
          magni delectus maiores in dignissimos eius ab sit consequatur, quam
          modi explicabo aspernatur ipsa libero beatae molestias cumque omnis,
          expedita esse impedit ullam! Dolores voluptatum non esse nam commodi
          tempore!
        </p>
      </div>
    </div>
